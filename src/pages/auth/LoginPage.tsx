...
const FIREBASE_MSG: Record<string, string> = {
  ...
  'auth/unauthorized-domain':    'โดเมนนี้ไม่ได้รับอนุญาตใน Firebase',
  'auth/too-many-requests':      'พยายามเข้าสู่ระบบหลายครั้งเกินไป กรุณารอสักครู่',
  'profile-not-found':           'ไม่พบข้อมูลผู้ใช้ในระบบ กรุณาติดต่อผู้ดูแล',
}
...
export default function LoginPage() {
  ...
  }, [userProfile, loading, firebaseUser, from, navigate])
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#0f2035] rounded-2xl px-8 py-6 mb-4 text-center shadow-xl">
          ...
          <h1 className="text-2xl font-bold text-white font-sarabun">PPE System</h1>
          <p className="text-slate-400 text-sm mt-1 font-sarabun">เข้าสู่ระบบเพื่อดำเนินการต่อ</p>
        </div>

        {/* Form card */}
        <div className="bg-white rounded-2xl shadow-lg px-8 py-7 space-y-5">
          ...
          <form onSubmit={handleEmail} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 text-sm border border-slate-300 rounded-lg outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-200 font-sarabun"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-9 pr-10 py-2.5 text-sm border border-slate-300 rounded-lg outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-200 font-sarabun"
                />
            ...
            >
              {busy ? <span className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <LogIn size={15} />}
              เข้าสู่ระบบ
            </button>
          </form>
          ...
          <p className="text-center text-xs text-slate-500 font-sarabun">
            ยังไม่มีบัญชี?{' '}
            <Link to="/register" className="text-blue-600 font-semibold hover:underline">สมัครสมาชิก</Link>
          </p>
        </div>
      </div>
    </div>
